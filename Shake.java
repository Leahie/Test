...
public class Shake implements PowerUps{//implementing the interface, thus u need to use the methods/functions in there i.d getX, getY etc
   ...
   public Shake(int xVal, int yVal){
      X=xVal;
